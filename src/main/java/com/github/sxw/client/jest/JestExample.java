...
import com.github.sxw.model.Product;
...
public class JestExample {
	...
	public static SearchResult booleanQuery() throws IOException {
		...
		QueryBuilder queryBuilder = QueryBuilders.boolQuery()
				...
				.should(QueryBuilders.termQuery("price",10))
				;
...
//	}
	...
	public static void main(String[] args) throws Exception {
		//创建mapping
//		String message = createMapping("my_store","product","ik");
//		System.out.println(message);

		//判断索引是否存在
//		JestResult result = indicesExists("bus");


		//关闭索引
//		JestResult result = closeIndex("news");
		//打开索引
//		JestResult result = openIndex("news");
		//查看节点信息
//		JestResult result = nodesInfo();
		//查看集群健康信息
//		JestResult result = nodesStats();
		//boolean查询
//		SearchResult result = booleanQuery();
//		System.out.println(result.getJsonString());
